                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="internet" role="tabpanel"
                                    ...
                                    <table class="table table-hover mt-2">
                                        ...
                                        <tbody>
                                        <%--@elvariable id="internetTariffs" type="java.util.List"--%>
                                ...
                                <div class="tab-pane fade" id="iptv" role="tabpanel" aria-labelledby="iptv-tab">
                                    <table class="table table-hover mt-2">
                                        ...
                                        <tbody>
                                        <%--@elvariable id="iptvTariffs" type="java.util.List"--%>
                                                                        ...
                                                                        <form method="post"
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control"
                                                                                          ...
                                                                                          rows="3" minlength="10"
                                                                                          maxlength="250"
                                                                                          required>${iptvTariff.description}
                                                                                </textarea>
                                                                                </label>
                                                                            </div>
                                                                            <input type="hidden" name="tariff_id"
                                ...
                                <div class="tab-pane fade" id="telephony" role="tabpanel"
                                    ...
                                    <table class="table table-hover mt-2">
                                        ...
                                        <tbody>
                                        <%--@elvariable id="telephonyTariffs" type="java.util.List"--%>
