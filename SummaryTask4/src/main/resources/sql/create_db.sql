...
--
-- Table structure for table `tariffied_users`
--

DROP TABLE IF EXISTS tariffed_users;

CREATE TABLE tariffied_users (
  `users_id` int(11) NOT NULL,
  `tariffs_id` int(11) NOT NULL,
  PRIMARY KEY (`users_id`,`tariffs_id`),
  KEY `fk_tariffies_users_tariffs1_idx` (`tariffs_id`),
  KEY `fk_tariffies_users_users1_idx` (`users_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
